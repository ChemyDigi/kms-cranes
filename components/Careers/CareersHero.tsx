      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="max-w-3xl space-y-4">
          ...
          <p className="text-base sm:text-lg text-zinc-300 font-sans max-w-2xl leading-relaxed">
            KMS Cranes operates modern high-tonnage machinery across Sri Lanka&apos;s most vital infrastructure sites. We are seeking certified, safety-first operators, riggers, and technicians.
          </p>
        </div>
      </div>
    </section>
